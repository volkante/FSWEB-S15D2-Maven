...
public class StringSet {
    ...
    public static Set<String> findUniqueWords(){
        ...
        //NOT: split(" ") boşlukları doğru şekilde yönetemeyebilir. Bunun için \\s+ kullandık.
        // Bu ifade, bir veya birden fazla boşluğu alır, daha güvenli bir bölme işlemi sağlar

        //Benzersiz ve sıralı kelimeleri TreeSet ile depola;
        Set<String> wordSet = new TreeSet<>(List.of(words));
